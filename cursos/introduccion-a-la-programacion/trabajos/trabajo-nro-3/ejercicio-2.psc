Algoritmo sin_titulo
    ...
    Escribir "¿Cuánto tiempo tiene para llegar a tiempo al trabajo (en minutos)?"
    Leer tiempo
    
    Escribir "¿Tiene el monto exacto para el pasaje (1: Sí, 0: No)?"
    Leer monto
    
    Escribir "¿Lleva mochila (1: Sí, 0: No)?"
    Leer lleva_mochila
    
    Escribir "¿Lleva bolso (1: Sí, 0: No)?"
    Leer lleva_bolso
    ...
    Mostrar "Resultado:"
    Mostrar "¿Subió al transporte? " + subio
    Mostrar "¿Usó carro grande? " + uso_carro_grande
FinAlgoritmo
